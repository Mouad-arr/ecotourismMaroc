/* Contact form validation and image preview
  - Validates: fullname, age >=18, email, password >=6 and match, file types (pdf/jpg/jpeg)
  - Shows per-field inline errors and clears them on user fix
  - Shows a friendly success message on valid submit (front-end only)
  - Provides image preview for JPG/JPEG and a simple PDF metadata for PDF
*/
